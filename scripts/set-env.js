...
export const environment = {
  production: false,
  baseURL: '${devConfig.backendUrl}',
  apiEndpoint: '${devConfig.backendUrl}',
  storageEncryptionKey: '${devConfig.storageEncryptionKey}',
  basicAuthToken: '${devConfig.basicAuthToken}'
};
`;
...
export const environment = {
  production: true,
  baseURL: '${prodConfig.backendUrl}',
  apiEndpoint: '${prodConfig.backendUrl}',
  storageEncryptionKey: '${prodConfig.storageEncryptionKey}',
  basicAuthToken: '${prodConfig.basicAuthToken}'
};
`;
