...
export class ViewPosComponent implements OnInit {
  ...
  cancelPo() {
    swal({
      ...
      html: `<h6 style="font-size:13px">You want to cancel the PO: <b>${this.poData.poId}</b> </h6>`,
      type: 'warning',
  ...
  acceptPo() {
    swal({
        title: `<h4>Are you sure?</h4>`,
        html: `<h6 style="font-size:13px">You want to Approve the PO: <b>${this.poData.poId}</b> </h6>`,
        type: 'warning',
        confirmButtonText: 'Yes',
        confirmButtonColor: '#006dd5',
        cancelButtonColor: '#d63636',
  ...
  approvePo() {
    swal({
      ...
      if (result.value) {
        this.poService.poApprovedByClientApproved({id: this.poData.id, approver: { id: localStorage.getItem('loggedId') }}).subscribe((res) => {
  ...
  rejectPo() {
    swal({
        title: `<h4>Are you sure?</h4>`,
        html: `<h6 style="font-size:13px">You want to Reject the PO : <b>${this.poData.poId}</b> </h6>`,
        type: 'warning',
        confirmButtonText: 'Yes',
        confirmButtonColor: '#006dd5',
        cancelButtonColor: '#d63636',
