...
@Component({
    selector: 'app-bfs-common-grid',
    templateUrl: './bfs-common-grid.component.html',
    styleUrls: ['./bfs-common-grid.component.scss']
})
export class BFSCommonGridComponent implements OnInit, OnChanges {
