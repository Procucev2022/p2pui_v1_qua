...
describe('GeneratedPposComponent', () => {
  ...
  it('branch-path coverage harness', () => {
    ...
    try { (component as any).getPPOs(); } catch (e) { /* ignore */ }
    try { (component as any).getPPOs(null); } catch (e) { /* ignore */ }
    try { (component as any).getPPOs({ id: '1', vendorId: 'v1', status: 'Open', graphTitle: 'Price: X', target: { value: 'x', files: [] }, preventDefault() {}, stopPropagation() {} }); } catch (e) { /* ignore */ }
    try { (component as any).getPPOs(true); } catch (e) { /* ignore */ }
    try { (component as any).getPPOs(false); } catch (e) { /* ignore */ }
  ...
  it('focused uncovered-method coverage', () => {
    const methods: string[] = ["ngOnInit","getAllPPOs","getClientPPOS","ppoActions","exportAsXLSX"];
    const row: any = {
