...
@Component({
    ...
    templateUrl: './create-pr-modal.component.html',
    styleUrls: ['./create-pr-modal.component.scss'],
    encapsulation: ViewEncapsulation.None,
})
export class CreatePrModalComponent implements OnInit {
    ...
    onSubmit(form: NgForm) {
        if (this.savedPRData && this.deliveryLocationList[0].address.length && this.estimatedPrvalue && form.value.dueDate && form.value.prCorrespond) {
