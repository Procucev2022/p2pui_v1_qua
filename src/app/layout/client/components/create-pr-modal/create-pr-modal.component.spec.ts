...
describe('CreatePrModalComponent', () => {
  ...
  it('focused uncovered-method coverage', () => {
    const methods: string[] = ["numberOnly","ngOnInit","uploadDocuments","deleteAttachment","onSubmit","uploadRateCard","uploadLineItemFile","uploadBOQFile","formSave","updatePRList"];
    const row: any = {
