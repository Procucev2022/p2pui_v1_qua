...
describe('ClientProcureRequestComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(ClientProcureRequestComponent, '')
      .overrideComponent(ClientProcureRequestComponent, { set: { providers: [] } })
      .compileComponents();
...
// big90 service rebind
  ...
  it('real method and branch coverage', () => {
    ...
    client.getPRByClientStatus.and.returnValue(of(rows));
    client.getPRitemsByid.and.returnValue(of([{ id: 'li1' }]));
    client.getPrById.and.returnValue(of({ id: '1', prId: 'P1' }));
    client.getPrSummaryData.and.returnValue(of(rows));
    approve.approvePRServices.and.returnValue(of({ status: 'Success', message: 'ok' }));
    ...
    c.prSummaryList = rows;
    c.exportAsXLSX();
    c.ngOnDestroy();
    expect(c.prSummaryList.length).toBe(4);
