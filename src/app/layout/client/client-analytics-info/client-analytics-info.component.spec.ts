...
describe('ClientAnalyticsInfoComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(ClientAnalyticsInfoComponent, '')
      .overrideComponent(ClientAnalyticsInfoComponent, { set: { providers: [] } })
      .compileComponents();
  ...
  it('focused real branch paths', () => {
    ...
    try { c.getChartDetails(true); } catch (e) {}
    try { c.getChartDetails(false); } catch (e) {}
    try { c.getChartDetails({ id: '1', vendorId: 'v1', invalid: false, valid: true, value: { id: '1' }, status: 'Success', statusCode: 200, message: 'ok', target: { value: 'x', files: [] }, preventDefault() {}, stopPropagation() {} }); } catch (e) {}
    try { c.onSubmit(); } catch (e) {}
    try { c.onSubmit(null); } catch (e) {}
    try { c.onSubmit(true); } catch (e) {}
    try { c.onSubmit(false); } catch (e) {}
