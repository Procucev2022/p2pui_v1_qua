...
@Component({
    selector: 'app-client-procure-request-opex',
    templateUrl: './client-procure-request-opex.component.html',
    styleUrls: ['./client-procure-request-opex.component.scss'],
    animations: [
...
export class ClientProcureRequestOpexComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        if (this.loggedUserDetails.role.roleName !== 'ClientInitiator'   ) {
            ...
            this.prSummaryHeaders.push({field: 'procucevStatus', header: 'Status', isLink: false, width: '120px' , fieldType: 'text', head: 'procucevStatus'});

        }else{
            this.prSummaryHeaders.push(  { field: 'clientStatus', header: 'Status', isLink: false , width: '175px' , fieldType: 'text', head: 'Status',
    ...
    getPrSummaryData() {
        ...
        this.clientService
            ...
            .subscribe(data => {
                ...
                this.prSummaryList = Array.isArray(data)? data.filter(ele => !ele.capexFlag || ele.capexFlag == false): [];
        });
    }
