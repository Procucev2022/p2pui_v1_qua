...
describe('RfqDocumentsComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(RfqDocumentsComponent, '')
      .overrideComponent(RfqDocumentsComponent, { set: { providers: [] } })
      .compileComponents();
  ...
  it('pattern-branch coverage', () => {
    ...
    try { c.getDocumentsByRfqId(); } catch (e) {}
    try { c.getDocumentsByRfqId({ invalid: false, valid: true, value: { id: '1' }, form: { valid: true }, id: '1', status: 'Success', message: 'ok', target: { value: 'x', files: [], checked: true }, preventDefault() {}, stopPropagation() {} }); } catch (e) {}
    try { c.getDocumentsByRfqId({ invalid: true, valid: false, value: {}, form: { valid: false } }); } catch (e) {}
    try { c.getDocumentsByRfqId(null); } catch (e) {}
    try { c.getDocumentsByRfqId(true); } catch (e) {}
    try { c.getDocumentsByRfqId(false); } catch (e) {}
  ...
  it('focused real branch paths', () => {
    ...
    try { c.getDocumentsByRfqId(true); } catch (e) {}
    try { c.getDocumentsByRfqId(false); } catch (e) {}
    try { c.getDocumentsByRfqId({ id: '1', vendorId: 'v1', invalid: false, valid: true, value: { id: '1' }, status: 'Success', statusCode: 200, message: 'ok', target: { value: 'x', files: [] }, preventDefault() {}, stopPropagation() {} }); } catch (e) {}
    try { c.ngOnChanges(); } catch (e) {}
    try { c.ngOnChanges(null); } catch (e) {}
    try { c.ngOnChanges(true); } catch (e) {}
    try { c.ngOnChanges(false); } catch (e) {}
