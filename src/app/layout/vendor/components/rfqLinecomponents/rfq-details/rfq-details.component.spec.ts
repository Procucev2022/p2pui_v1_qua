...
describe('RfqDetailsComponent', () => {
  ...
  it('pattern-branch coverage', () => {
    ...
    try { c.getRfqsList(); } catch (e) {}
    try { c.getRfqsList({ invalid: false, valid: true, value: { id: '1' }, form: { valid: true }, id: '1', status: 'Success', message: 'ok', target: { value: 'x', files: [], checked: true }, preventDefault() {}, stopPropagation() {} }); } catch (e) {}
    try { c.getRfqsList({ invalid: true, valid: false, value: {}, form: { valid: false } }); } catch (e) {}
    try { c.getRfqsList(null); } catch (e) {}
    try { c.getRfqsList(true); } catch (e) {}
    try { c.getRfqsList(false); } catch (e) {}
