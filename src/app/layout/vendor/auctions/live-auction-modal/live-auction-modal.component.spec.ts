...
describe('LiveAuctionModalComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(LiveAuctionModalComponent, '')
      .overrideComponent(LiveAuctionModalComponent, { set: { providers: [] } })
      .compileComponents();
  ...
  it('pattern-branch coverage', () => {
    ...
    try { c.ongetTotalBid(); } catch (e) {}
    try { c.ongetTotalBid({ invalid: false, valid: true, value: { id: '1' }, form: { valid: true }, id: '1', status: 'Success', message: 'ok', target: { value: 'x', files: [], checked: true }, preventDefault() {}, stopPropagation() {} }); } catch (e) {}
