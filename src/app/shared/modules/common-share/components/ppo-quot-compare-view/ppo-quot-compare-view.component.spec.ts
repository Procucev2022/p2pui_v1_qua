...
describe('PpoQuotCompareViewComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(PpoQuotCompareViewComponent, '')
      .overrideComponent(PpoQuotCompareViewComponent, { set: { providers: [] } })
      .compileComponents();
  ...
  it('focused uncovered-method coverage', () => {
    const methods: string[] = ["downloadAsPDF","downloadImage","itemClicked","prChange","getGST","getGSTValue","getQuotTotal","getMinMaxValue","exportToExcel","getCompareQuoteExcelByPR","excelDownload"];
    const row: any = {
