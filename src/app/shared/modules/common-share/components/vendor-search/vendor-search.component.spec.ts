...
import { MAT_DIALOG_SCROLL_STRATEGY, MAT_DIALOG_DATA, MatDialogRef, MatDialog } from '@angular/material/dialog';
...
describe('VendorSearchComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideTemplate(VendorSearchComponent, '')
      .overrideComponent(VendorSearchComponent, { set: { providers: [] } })
      .compileComponents();
  ...
  it('focused uncovered-method coverage', () => {
    const methods: string[] = ["selectChangeHandler","getHeadings","getGroups","getSacs","getFamilyNames","getClassNames","getCommodityNames","getHsnCode","getSacCode","onSubmit","resetForm","sendRfqToVendors"];
    const row: any = {
